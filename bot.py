...
def gerar_ofertas():
    todas_ofertas = [
        ...
        {'titulo': 'Balança Digital Corporal Multilaser', 'preco': 69.90, 'preco_original': 139.90, 'desconto': 50, 'link': f'https://www.amazon.com.br/s?k=balança+digital+multilaser&tag={AMAZON_TAG}', 'loja': 'Amazon'},
        ...
        # AUTOMOTIVO
        {'titulo': 'Suporte Veicular Celular Giro 360° Magnético', 'preco': 29.90, 'preco_original': 69.90, 'desconto': 57, 'link': f'https://shopee.com.br/search?keyword=suporte+celular+carro+magnetico', 'loja': 'Shopee'},
